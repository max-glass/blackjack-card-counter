...
# 30JUL2022
# BB31420
# Added total card count and nuetral card logging.
...
def clicked(): # without event because I use `command=` instead of `bind`
    ...
    label2.configure(text=f'Cards Played = {cardsPlayed}')
